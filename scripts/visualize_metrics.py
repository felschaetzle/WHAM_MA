...
ax1.bar(r1, rte_dpvo, color="b", width=bar_width, edgecolor="grey", label="DPVO")
ax1.bar(r2, rte_gt_intrinsics, color="r", width=bar_width, edgecolor="grey", label="gt_intrinsics")
...
ax1.set_ylabel("RTE")
ax1.set_title(f"Comparison of RTE (Avg DPVO: {avg_rte_dpvo:.3f}, Avg gt_intrinsics: {avg_rte_gt_intrinsics:.3f})")
ax1.legend()
...
ax2.bar(r1, rte_gt_intrinsics, color="r", width=bar_width, edgecolor="grey", label="gt_intrinsics")
ax2.bar(r2, rte_gt_camera, color="g", width=bar_width, edgecolor="grey", label="gt_camera")
...
ax2.set_ylabel("RTE")
ax2.set_title(f"Comparison of RTE (Avg gt_intrinsics: {avg_rte_gt_intrinsics:.3f}, Avg gt_camera: {avg_rte_gt_camera:.3f})")
ax2.legend()
...
ax3.bar(r1, rte_gt_camera, color="g", width=bar_width, edgecolor="grey", label="gt_camera")
ax3.bar(r2, rte_gt_camera_wo_SMPLify, color="m", width=bar_width, edgecolor="grey", label="gt_camera_wo_SMPLify")
...
ax3.set_ylabel("RTE")
ax3.set_title(f"Comparison of RTE (Avg gt_camera: {avg_rte_gt_camera:.3f}, Avg gt_camera_wo_SMPLify: {avg_rte_gt_camera_wo_SMPLify:.3f})")
ax3.legend()
